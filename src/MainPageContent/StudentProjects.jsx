...
function StudentProjects() {
  ...
  const ShowProjectDeta = (event) => {
   ...
   const studentProjects=projects.filter(p=> p.students.includes(activeUser.id));
  const projecsAfterSearch=studentProjects.filter(p=>{
  ...
  return (
    ...
    <header className=" items-center h-[15%] mb-5">
        ...
        ">
           ...
           <div className="w-[20%]   rounded-[7px] md:h-full   md:w-[184px] md:text-lg border-none" id="notaddprojectbtn"></div>
